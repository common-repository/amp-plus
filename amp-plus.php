			...
			// Get-Parameter Case-Insensitive setzen ------------------------------------
				...
				if($amp_preview == 1)
				{
					// Allgemeine Daten -------------------------------------------------
						...
						$amp_cloud_ws_user_agent		= "WordPress Plugin - AMP Plus - ".$_SERVER["HTTP_HOST"]." (+".amp_cloud_get_urlaktuellos().")";
										...
										// Prüfen, ob Datei im Cache ist
											...
											if(file_exists("".$urlCACHEdatei.""))
											{
												...
												// Datei-Datum prüfen
													...
													//$dateiTIME_diff	= ( 60 * 24 * 1) ; 								// in Sekunden (einmal pro Tag)
													$dateiTIME_diff		= ( 60 * 60 * 24 * 3 ) ; 						// in Sekunden (alle drei Tage)
							...
							else
							{
								// AMP-Seite von AMP-Cloud.de laden und ausgeben
									...
									// amp-cloud.de AMP-HTML-Adresse
										...
										$ampcloud_url		= "https://www.amp-cloud.de/amp/amp-plus.php?s=".urlencode("".$urlARTIKEL."")."";
